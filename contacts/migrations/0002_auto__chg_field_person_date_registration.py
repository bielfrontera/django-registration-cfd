...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.date_registration'
        db.alter_column('contacts_people', 'date_registration', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2013, 2, 3)))


    def backwards(self, orm):
        
        # Changing field 'Person.date_registration'
        db.alter_column('contacts_people', 'date_registration', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 23, 38, 29, 425243)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 23, 38, 29, 425131)'}),
        ...
        'contacts.person': {
            ...
            'date_registration': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
